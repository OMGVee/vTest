...
<body>
<form id='frmGrabAlertTotals' action="grab_alert_totals.php" method="post">
...
<input type="submit" onclick="LoadContent('maincontent','./grab_alert_totals.php');" name="submit" value="Submit">
</form>
</body>
</html>
